...
public class Materials : MonoBehaviour
{
	...
	void Start()
	{
		// All tweens will be created in a paused state, so they can be toggled via the UI
		...
		// EMISSION
		// The float value you see in Unity's inspector, next to the emission's color,
