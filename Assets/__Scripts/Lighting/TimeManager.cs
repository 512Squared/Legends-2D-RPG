...
public class TimeManager : MonoBehaviour
{
    ...
    public static UnityAction<_DateTime> OnDateTimeChanged;

    private void Awake()
    {
        dateTime = new _DateTime(dateInMonth, season, year, hour, minutes * 10, true);
...
public struct _DateTime
{
    ...
    public _DateTime(int date, int season, int year, int hour, int minutes, bool railwayTime)
    {
    ...
    {
        if (year == 0) year = 1;
        return new _DateTime(1, 0, year, 6, 0, true);
    }

    public _DateTime SummerSolstice(int year)
    {
        if (year == 0) year = 1;
        return new _DateTime(28, 1, year, 6, 0, true);
    }
    public _DateTime PumpkinHarvest(int year)
    {
        if (year == 0) year = 1;
        return new _DateTime(28, 2, year, 6, 0, true);
    }
    ...
    public _DateTime StartOfSeason(int season, int year)
    {
        ...
        return new _DateTime(1, season, year, 6, 0, true);
    }
    ...
    public string TimeToString12()
    {
        ...
        return $"{adjustedHour.ToString("D2")}:{minutes.ToString("D2")}";
    }
