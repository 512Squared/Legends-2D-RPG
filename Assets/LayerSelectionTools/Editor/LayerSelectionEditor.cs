...
namespace LayerSelectionTools.Editor
{
    [InitializeOnLoad]
    public class LayerSelectionEditor : EditorWindow
    {
        ...
        private static bool foldUp = false;
        ...
        private Vector2 scrollPosition = new(0,100);
        void OnGUI()
        {
            ...
            if (foldUp = EditorGUILayout.Foldout(foldUp, "Individual settings"))
            {
    ...
    class HierarchyIcon
    {
        ...
        static HierarchyIcon()
        {
            // Init
            texture =
                AssetDatabase.LoadAssetAtPath("Assets/LayerSelectionTools/Testicon.png",
