...
namespace DialogueEditor
{
    ...
    public class UISpeechNode : UINode
    {
        ...
        // Properties
        public EditableSpeechNode SpeechNode => Info as EditableSpeechNode;
        public override Color DefaultColor => DialogueEditorUtil.Colour(189, 0, 0);
        public override Color SelectedColor => DialogueEditorUtil.Colour(255, 0, 0);
        ...
        public override void OnDraw()
        {
            ...
            Rect name = new Rect(rect.x + (TEXT_BORDER * 0.5f), rect.y + NAME_PADDING + TITLE_HEIGHT,
                rect.width - (TEXT_BORDER * 0.5f), NAME_HEIGHT);
            GUI.Box(name, SpeechNode.Name, npcNameStyle);

            // Icon
            Rect icon = new Rect(rect.x + (TEXT_BORDER * 0.5f), rect.y + TITLE_HEIGHT + TITLE_GAP + NAME_HEIGHT,
                SPRITE_SZ, SPRITE_SZ);
    ...
    public class UIOptionNode : UINode
    {
        ...
        // Properties
        public EditableOptionNode OptionNode => Info as EditableOptionNode;
        public override Color DefaultColor => DialogueEditorUtil.Colour(0, 158, 118);
        public override Color SelectedColor => DialogueEditorUtil.Colour(0, 201, 150);
